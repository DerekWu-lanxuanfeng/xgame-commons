package org.xgame.commons.reflect;
...
/**
 * @Name: ReflectUtils.class
 * @Description: // 反射的类型
 * @Create: DerekWu on 2018/3/3 11:16
 * @Version: V1.0
 */
public class ReflectUtils {
    ...
    public static Object getFieldValue(final Object obj, final String fieldName) {
        ...
        try {
            ...
            LOG.error("an exception that cannot be thrown{}", e.getMessage());
        }
        return result;
    }
     ...
     * 用于一次性调用的情况，否则应使用getAccessibleMethod()函数获得Method后反复调用. 同时匹配方法名+参数类型，
     */
    public static Object invokeStaticMethod(final Class clazz, final String methodName, final Class<?>[] parameterTypes, final Object ...args) {
        Method method = getAccessibleMethod(clazz, methodName, parameterTypes);
        if (method == null) {
            throw new IllegalArgumentException("Could not find method [" + methodName + "] on target [" + clazz.getName() + "]");
        }
     ...
     * 只匹配函数名，如果有多个同名函数调用第一个。
     */
    public static Object invokeStaticMethodByName(final Class clazz, final String methodName, final Object ...args) {
